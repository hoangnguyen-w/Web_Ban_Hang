...
import com.example.web_ban_hang.adapter.DienThoaiAdapter;
...
public class DienThoaiActivity extends AppCompatActivity {
                ...
                .subscribe(
                        sanPhamMoiModel -> {
                            if(sanPhamMoiModel.isSuccess()){
                                ...
                                Toast.makeText(getApplicationContext(), "Hết dữ liệu rôi", Toast.LENGTH_LONG).show();
                                isLoading = true;
                            }
                        }, 
                        throwable -> {
    ...
    private void AnhXa() {
        ...
        recyclerView = (RecyclerView) findViewById(R.id.recycleview_dt);
